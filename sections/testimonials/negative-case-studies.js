...
import clientData from '../../components/case-studies/negative-case-study.data';
import { useMediaQuery } from 'react-responsive';
import CaseStudyCard from '../../components/cards/case-study-card';


export default function NegativeCaseStudies() {
...
<>{clientData.map(({ client, occupation, goal, how, testimonial }, i) => (
    ...
    <section id="written" sx={styles.services} key={i}>
      <Container sx={styles.containerBox}>
        <CaseStudyCard failed={true} client={client} occupation={occupation} goal={goal} />
      </Container>
